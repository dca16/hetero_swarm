...
dataset_train.load_data('/Users/domalberts/Documents/GitHub/hetero_swarm/multi_rcnn_tagged.json', '/Users/domalberts/Documents/GitHub/hetero_swarm/rcnn_images')
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('/Users/domalberts/Documents/GitHub/hetero_swarm/multi_rcnn_tagged.json', '/Users/domalberts/Documents/GitHub/hetero_swarm/rcnn_images')
dataset_val.prepare()
...
for image_id in image_ids:
    ...
    display_top_masks(image, mask, class_ids, dataset.class_names, limit=6)  #limit to total number of classes
'''
...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "/Users/domalberts/Documents/GitHub/hetero_swarm/logs")
# Path to trained weights file
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "/Users/domalberts/Documents/GitHub/hetero_swarm/mask_rcnn_coco.h5")
...
# load model weights
model.load_weights('/Users/domalberts/Documents/GitHub/hetero_swarm/mask_rcnn_coco.h5', by_name=True)
...
marbles_img = skimage.io.imread("/Users/domalberts/Documents/GitHub/hetero_swarm/full_env_verify/step_57.png")
plt.imshow(marbles_img)

detected = model.detect([marbles_img])
results = detected[0]
class_names = ['Red Cube', 'Green Cube', 'Blue Cube', 'Red Cyl', 'Green Cyl', 'Blue Cyl']
...
detect_and_color_splash(model, image_path="/Users/domalberts/Documents/GitHub/hetero_swarm/full_env_verify/step_57.png")
